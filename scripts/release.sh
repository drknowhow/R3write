...
#      keeps working across releases. After this completes, also upload the
#      installer to Lemon Squeezy so paid users get the new version:
...
printf '\n\033[1;33m→\033[0m Also upload the installer to Lemon Squeezy so paid users get the new version:\n'
